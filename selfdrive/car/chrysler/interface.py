...
class CarInterface(CarInterfaceBase):
  ...
  def init(logcan, sendcan):
    disable_ecu(logcan, sendcan, bus=2, addr=0x753, com_cont_req=b'\x28\x83\x00')
    disable_ecu(logcan, sendcan, bus=1, addr=0x753, com_cont_req=b'\x28\x83\x01')
    disable_ecu(logcan, sendcan, bus=2, addr=0x753, com_cont_req=b'\x28\x83\x01')
    disable_ecu(logcan, sendcan, bus=1, addr=0x753, com_cont_req=b'\x28\x83\x02')     
    disable_ecu(logcan, sendcan, bus=2, addr=0x753, com_cont_req=b'\x28\x83\x02')    
    disable_ecu(logcan, sendcan, bus=2, addr=0x753, com_cont_req=b'\x28\x83\x03')
    disable_ecu(logcan, sendcan, bus=2, addr=0x753, com_cont_req=b'\x28\x83\x04')   
    disable_ecu(logcan, sendcan, bus=2, addr=0x753, com_cont_req=b'\x28\x83\x05') 
    disable_ecu(logcan, sendcan, bus=2, addr=0x753, com_cont_req=b'\x28\x83\x06')
    disable_ecu(logcan, sendcan, bus=2, addr=0x753, com_cont_req=b'\x28\x83\x07')
    disable_ecu(logcan, sendcan, bus=2, addr=0x753, com_cont_req=b'\x02\x10\x85')
